...
Flat.create!([{
  ...
  {
    name: 'Clear & Spacious Garden Flat London',
  ...
  {
    name: 'Green & Spacious Garden Flat London',
    address: '13 Clifton Gardens London W9 1DT',
    description: 'A lovely fall feel for this spacious garden flat. Two double bedrooms, open plan living area, large kitchen and a beautiful conservatory',
    price_per_night: 85,
    number_of_guests: 6
  }
])
